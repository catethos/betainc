...
#define __PYX_HAVE__betainc__betainc
#define __PYX_HAVE_API__betainc__betainc
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'betainc.betainc' */
static double __pyx_v_7betainc_7betainc_STOP;
static double __pyx_v_7betainc_7betainc_TINY;
static double __pyx_f_7betainc_7betainc_incbeta(double, double, double); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_double_t = { "double_t", NULL, sizeof(__pyx_t_5numpy_double_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "betainc.betainc"
extern int __pyx_module_is_main_betainc__betainc;
int __pyx_module_is_main_betainc__betainc = 0;

/* Implementation of 'betainc.betainc' */
...
static const char __pyx_k_betacdf[] = "betacdf";
static const char __pyx_k_ImportError[] = "ImportError";
static const char __pyx_k_betainc_betainc[] = "betainc.betainc";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_betainc_betainc_pyx[] = "betainc/betainc.pyx";
static const char __pyx_k_numpy_core_multiarray_failed_to[] = "numpy.core.multiarray failed to import";
static const char __pyx_k_numpy_core_umath_failed_to_impor[] = "numpy.core.umath failed to import";
static PyObject *__pyx_n_s_ImportError;
static PyObject *__pyx_n_s_N;
static PyObject *__pyx_n_s_asarray;
static PyObject *__pyx_n_s_betacdf;
static PyObject *__pyx_n_s_betainc_betainc;
static PyObject *__pyx_kp_s_betainc_betainc_pyx;
...
static PyObject *__pyx_pf_7betainc_7betainc_betacdf(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_xs, double __pyx_v_p, double __pyx_v_q); /* proto */
...
static double __pyx_f_7betainc_7betainc_incbeta(double __pyx_v_a, double __pyx_v_b, double __pyx_v_x) {
  double __pyx_v_lbeta_ab;
 ...
 * 
 */
  __pyx_t_1 = ((__pyx_v_x > ((__pyx_v_a + 1.0) / ((__pyx_v_a + __pyx_v_b) + 2.0))) != 0);
  if (__pyx_t_1) {

    /* "betainc/betainc.pyx":23
 * 
 *     if x > (a+1)/(a+b+2):
 *         return 1 - incbeta(b, a, 1-x)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_r = (1.0 - __pyx_f_7betainc_7betainc_incbeta(__pyx_v_b, __pyx_v_a, (1.0 - __pyx_v_x)));
    goto __pyx_L0;
 ...
 * 
 */
  __pyx_v_lbeta_ab = ((lgamma(__pyx_v_a) + lgamma(__pyx_v_b)) - lgamma((__pyx_v_a + __pyx_v_b)));

  /* "betainc/betainc.pyx":26
 * 
 *     cdef double lbeta_ab = lgamma(a) + lgamma(b) - lgamma(a+b)
 *     cdef double front = exp(log(x)*a + log(1-x)*b - lbeta_ab) / a             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_front = (exp((((log(__pyx_v_x) * __pyx_v_a) + (log((1.0 - __pyx_v_x)) * __pyx_v_b)) - __pyx_v_lbeta_ab)) / __pyx_v_a);

  /* "betainc/betainc.pyx":28
 *     cdef double front = exp(log(x)*a + log(1-x)*b - lbeta_ab) / a
 * 
 *     cdef double f=1.0, c=1.0, d=0.0             # <<<<<<<<<<<<<<
 * 
 ...
 *             numerator = 1.0
 */
    __pyx_v_m = (((long)__pyx_v_i) / 2);

    /* "betainc/betainc.pyx":34
 *     for i in range(200):
 *         m = i/2
 *         if i == 0:             # <<<<<<<<<<<<<<
 *             numerator = 1.0
 ...
 */
      __pyx_v_numerator = (((__pyx_v_m * (__pyx_v_b - __pyx_v_m)) * __pyx_v_x) / (((__pyx_v_a + (2.0 * __pyx_v_m)) - 1.0) * (__pyx_v_a + (2.0 * __pyx_v_m))));
 ...
 */
    /*else*/ {
      __pyx_v_numerator = ((-(((__pyx_v_a + __pyx_v_m) * ((__pyx_v_a + __pyx_v_b) + __pyx_v_m)) * __pyx_v_x)) / ((__pyx_v_a + (2.0 * __pyx_v_m)) * ((__pyx_v_a + (2.0 * __pyx_v_m)) + 1.0)));
    }
    __pyx_L9:;

    /* "betainc/betainc.pyx":40
 *         else:
 *             numerator = -((a+m)*(a+b+m)*x)/((a+2.0*m)*(a+2.0*m+1))
 *         d = 1.0 + numerator * d             # <<<<<<<<<<<<<<
 *         if (fabs(d) < TINY):
 *             d = TINY
 */
    __pyx_v_d = (1.0 + (__pyx_v_numerator * __pyx_v_d));

    /* "betainc/betainc.pyx":41
 *             numerator = -((a+m)*(a+b+m)*x)/((a+2.0*m)*(a+2.0*m+1))
 *         d = 1.0 + numerator * d
 *         if (fabs(d) < TINY):             # <<<<<<<<<<<<<<
 *             d = TINY
 *         d = 1.0/d
 */
    __pyx_t_1 = ((fabs(__pyx_v_d) < __pyx_v_7betainc_7betainc_TINY) != 0);
    if (__pyx_t_1) {

      /* "betainc/betainc.pyx":42
 *         d = 1.0 + numerator * d
 *         if (fabs(d) < TINY):
 *             d = TINY             # <<<<<<<<<<<<<<
 *         d = 1.0/d
 *         c = 1.0 + numerator / c
 */
      __pyx_v_d = __pyx_v_7betainc_7betainc_TINY;
 ...
 *             c = TINY
 */
    __pyx_v_c = (1.0 + (__pyx_v_numerator / __pyx_v_c));

    /* "betainc/betainc.pyx":45
 *         d = 1.0/d
 *         c = 1.0 + numerator / c
 *         if (fabs(c) < TINY):             # <<<<<<<<<<<<<<
 *             c = TINY
 *         f *= c*d
 */
    __pyx_t_1 = ((fabs(__pyx_v_c) < __pyx_v_7betainc_7betainc_TINY) != 0);
    if (__pyx_t_1) {

      /* "betainc/betainc.pyx":46
 *         c = 1.0 + numerator / c
 *         if (fabs(c) < TINY):
 *             c = TINY             # <<<<<<<<<<<<<<
 *         f *= c*d
 * 
 */
      __pyx_v_c = __pyx_v_7betainc_7betainc_TINY;
 ...
 */
    __pyx_v_f = (__pyx_v_f * (__pyx_v_c * __pyx_v_d));

    /* "betainc/betainc.pyx":49
 *         f *= c*d
 * 
 *         if (fabs(1.0-c*d) < STOP):             # <<<<<<<<<<<<<<
 *             return front * (f - 1.0)
 * 
 */
    __pyx_t_1 = ((fabs((1.0 - (__pyx_v_c * __pyx_v_d))) < __pyx_v_7betainc_7betainc_STOP) != 0);
    if (__pyx_t_1) {

      /* "betainc/betainc.pyx":50
 * 
 *         if (fabs(1.0-c*d) < STOP):
 *             return front * (f - 1.0)             # <<<<<<<<<<<<<<
 * 
 *     return 1.0/0.0
 */
      __pyx_r = (__pyx_v_front * (__pyx_v_f - 1.0));
      goto __pyx_L0;
...
/* Python wrapper */
static PyObject *__pyx_pw_7betainc_7betainc_1betacdf(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_7betainc_7betainc_1betacdf = {"betacdf", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7betainc_7betainc_1betacdf, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_7betainc_7betainc_1betacdf(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("betacdf (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_xs,&__pyx_n_s_p,&__pyx_n_s_q,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_p)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("betacdf", 1, 3, 3, 1); __PYX_ERR(0, 57, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_q)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("betacdf", 1, 3, 3, 2); __PYX_ERR(0, 57, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "betacdf") < 0)) __PYX_ERR(0, 57, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("betacdf", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 57, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("betainc.betainc.betacdf", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_xs), __pyx_ptype_5numpy_ndarray, 1, "xs", 0))) __PYX_ERR(0, 57, __pyx_L1_error)
  __pyx_r = __pyx_pf_7betainc_7betainc_betacdf(__pyx_self, __pyx_v_xs, __pyx_v_p, __pyx_v_q);
...
static PyObject *__pyx_pf_7betainc_7betainc_betacdf(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_xs, double __pyx_v_p, double __pyx_v_q) {
  int __pyx_v_N;
  int __pyx_v_i;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("betacdf", 0);
  ...
  __pyx_pybuffernd_xs.rcbuffer = &__pyx_pybuffer_xs;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_xs.rcbuffer->pybuffer, (PyObject*)__pyx_v_xs, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 57, __pyx_L1_error)
  }
 ...
 */
  __pyx_v_N = (__pyx_v_xs->dimensions[0]);

  /* "betainc/betainc.pyx":59
 * def betacdf(np.ndarray[np.double_t, ndim=1] xs, double p, double q):
 *     cdef int N = xs.shape[0]
 *     cdef int i = 0             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.double_t, ndim=1] result = np.zeros(N)
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_result.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if ((1 == 0)) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel num_threads(10) private(__pyx_t_9)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
 ...
 */
                            __pyx_t_9 = __pyx_v_i;
                            __pyx_v_x = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_double_t *, __pyx_pybuffernd_xs.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_xs.diminfo[0].strides));

                            /* "betainc/betainc.pyx":64
 *     for i in prange(N, nogil=True, num_threads=10):
 *         x = xs[i]
 *         result[i] += incbeta(p, q, x)             # <<<<<<<<<<<<<<
 *     return np.asarray(result)
 */
                            __pyx_t_9 = __pyx_v_i;
                            *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_double_t *, __pyx_pybuffernd_result.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_result.diminfo[0].strides) += __pyx_f_7betainc_7betainc_incbeta(__pyx_v_p, __pyx_v_q, __pyx_v_x);
                        }
                    }
                }
            }
 ...
 */
  ...
  __pyx_t_1 = (__pyx_t_3) ? __Pyx_PyObject_Call2Args(__pyx_t_2, __pyx_t_3, ((PyObject *)__pyx_v_result)) : __Pyx_PyObject_CallOneArg(__pyx_t_2, ((PyObject *)__pyx_v_result));
...
static int __pyx_pymod_exec_betainc(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_betainc},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_betacdf, __pyx_k_betacdf, sizeof(__pyx_k_betacdf), 0, 0, 1, 1},
  {&__pyx_n_s_betainc_betainc, __pyx_k_betainc_betainc, sizeof(__pyx_k_betainc_betainc), 0, 0, 1, 1},
  {&__pyx_kp_s_betainc_betainc_pyx, __pyx_k_betainc_betainc_pyx, sizeof(__pyx_k_betainc_betainc_pyx), 0, 0, 1, 0},
 ...
 *     cdef int i = 0
 */
  __pyx_tuple__3 = PyTuple_Pack(7, __pyx_n_s_xs, __pyx_n_s_p, __pyx_n_s_q, __pyx_n_s_N, __pyx_n_s_i, __pyx_n_s_result, __pyx_n_s_x); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__3);
  __Pyx_GIVEREF(__pyx_tuple__3);
  __pyx_codeobj__4 = (PyObject*)__Pyx_PyCode_New(3, 0, 7, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__3, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_betainc_betainc_pyx, __pyx_n_s_betacdf, 57, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__4)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initbetainc(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initbetainc(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_betainc(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_betainc(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_betainc(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'betainc' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_betainc(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("betainc", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "betainc.betainc")) {
      if (unlikely(PyDict_SetItemString(modules, "betainc.betainc", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * 
 */
  __pyx_v_7betainc_7betainc_STOP = 1.0e-8;

  /* "betainc/betainc.pyx":13
 * 
 * cdef double STOP = 1.0e-8
 * cdef double TINY =  1.0e-30             # <<<<<<<<<<<<<<
 * 
 * @cython.cdivision(True)
 */
  __pyx_v_7betainc_7betainc_TINY = 1.0e-30;
 ...
 *     cdef int i = 0
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7betainc_7betainc_1betacdf, NULL, __pyx_n_s_betainc_betainc); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_betacdf, __pyx_t_1) < 0) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init betainc.betainc", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init betainc.betainc");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
